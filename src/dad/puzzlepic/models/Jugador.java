...
public class Jugador {
	...
	public Jugador() {
		...
		nombre = new SimpleStringProperty(this, "nombre", "Pepe");
		dificultad = new SimpleObjectProperty<>(this, "dificultad", Dificultad.FACIL);
		directorio = new SimpleObjectProperty<>(this, "directorio");
		modo = new SimpleObjectProperty<>(this, "modo", Modo.PUZZLE_PIECES);
		tiempo = new SimpleIntegerProperty(this, "tiempo", 30);
